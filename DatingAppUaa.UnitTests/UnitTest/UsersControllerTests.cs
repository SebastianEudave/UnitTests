...
namespace DatingAppUaa.UnitTests.Pruebas
{
    public class UsersControllerTests
    {
        ...
        public async Task GetUsers_OK(string statusCode, string username, string password)
        {
            // Arrange
        ...
        [Theory]
        [InlineData("OK", "lois", "Pa$$w0rd",2,8)]
        public async Task GetUsersPagination_OK(string statusCode, string username, string password, int pageSize, int pageNumber)
        {
            // Arrange
            _client.DefaultRequestHeaders.Authorization = null;
        ...
        public async Task GetUser_OK(string statusCode, string username, string password)
        {
            // Arrange
            var user = await LoginHelper.LoginUser(username, password);
            _client.DefaultRequestHeaders.Authorization = new AuthenticationHeaderValue("Bearer", user.Token);
        ...
        [Theory]
        [InlineData("Created", "admin", "Pa$$w0rd", "photo_1.jpg")]
        ...
        [Theory]
        [InlineData("NoContent", "margo", "Pa$$w0rd", "photo_2.jpg")]
        public async Task SetMainPhoto_NoContent(string statusCode, string username, string password, string file)
        {
            // Arrange
            _client.DefaultRequestHeaders.Authorization = null;
            var user = await LoginHelper.LoginUser(username, password);
        ...
        [Theory]
        [InlineData("OK", "karen", "Pa$$w0rd","photo_3.jpg")]
        ...
        [Theory]
        [InlineData("NotFound", "skinner", "Pa$$w0rd", "20")]
